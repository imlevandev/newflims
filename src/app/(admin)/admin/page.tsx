  ...
  return (
    <>
      <section className="admin-hero">
        ...
        <p className="lead">
          Theo dõi trạng thái hệ thống, quản lý dữ liệu phim và kích hoạt các luồng crawl.
        </p>
      </section>
      ...
      <section className="admin-stats-grid">
        ...
        <article className="admin-stat-card admin-stat-card--blue">
          ...
          <p className="admin-stat-card__note">Thống kê realtime, nhật ký crawl và trạng thái DB.</p>
        </article>
      </section>

      <section className="panel summary-card">
        <h2 style={{ margin: "0 0 18px", fontSize: "1.05rem", fontWeight: 700, color: "#f4f6fb" }}>
          Thao tác nhanh
        </h2>
